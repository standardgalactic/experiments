**Why Distributed Systems Should Preserve Enough History to Explain Their P[1D[K
Present State**
...
the current state of such complex environments is crucial because it allows[6D[K
